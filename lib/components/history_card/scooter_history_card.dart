...
class ScooterHistoryCard extends StatefulWidget {
  final History data;

  const ScooterHistoryCard({
    super.key,
    required this.data,
  });

  @override
  State<ScooterHistoryCard> createState() => _TokenHistoryCardState();
}

class _TokenHistoryCardState extends State<ScooterHistoryCard> {
