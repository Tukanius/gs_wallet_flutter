...
class WalkingCard extends StatefulWidget {
  final Account data;
  final bool isAll;
  const WalkingCard({super.key, required this.data, required this.isAll});

  @override
  State<WalkingCard> createState() => _WalkingCardState();
}

class _WalkingCardState extends State<WalkingCard> {
  bool isView = false;
