...
import 'package:green_score/components/history_card/step_history_card.dart';
...
class StepDetailPage extends StatefulWidget {
  ...
  static const routeName = "StepDetailPage";
...
class _StepDetailPageState extends State<StepDetailPage> with AfterLayoutMixin {
  ...
  int page = 1;
  int limit = 10;
  Result stepHistory = Result(rows: [], count: 0);
  ...
  list(page, limit, String startDate, String endDate) async {
    ...
    Filter filter = Filter(
      accumlationId: '${walk.id}',
      endDate: endDate,
      startDate: startDate,
    );
    stepHistory = await ScoreApi().getStepHistory(
            ...
            child: Column(
              ...
              children: [
                ...
                isLoading == true
                    ...
                    : stepHistory.rows!.isNotEmpty
                        ? Column(
                            children: stepHistory.rows!
                                .map(
                                  (data) => Column(
                                    children: [
                                      StepHistoryCard(
