...
import 'package:green_score/components/history_card/order_history_card.dart';
...
class _SaleDetailPageState extends State<SaleDetailPage> with AfterLayoutMixin {
  ...
  int page = 1;
  int limit = 10;
  Result orderHistory = Result(rows: [], count: 0);
  @override
  ...
  list(page, limit, String startDate, String endDate) async {
    ...
    orderHistory = await WalletApi().getSaleHistory(
            ...
            child: Column(
              ...
              children: [
                ...
                isLoading == true
                    ...
                    : orderHistory.rows!.isNotEmpty
                        ? Column(
                            children: orderHistory.rows!
                                .map(
                                  (data) => Column(
                                    children: [
                                      OrderHistoryCard(
